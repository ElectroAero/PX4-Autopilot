...
void UavcanJoystickCommand::periodic_update(const uavcan::TimerEvent &)
{
	...
	int roll = ((int)controlSetpoints.roll * 255);
	int pitch = ((int)controlSetpoints.pitch * 255);
	int yaw = ((int)controlSetpoints.yaw * 255);
	int throttle = ((int)controlSetpoints.throttle * 255);
